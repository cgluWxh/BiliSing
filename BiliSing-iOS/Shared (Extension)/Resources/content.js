...
(function() {
    ...
    function createFloatingWindow() {
        ...
        floatingWindow.innerHTML = `
            <div id="bilising-header">
                <span id="bilising-header-cotent">🎤 BiliSing</span>
        ...
        style.textContent = `
            ...
            #bilising-play-next:hover {
                background: #ff5252;
            }
            
            #bilising-play-next:disabled {
                background: #666;
                cursor: not-allowed;
            }
    ...
    function updateNextSong(playlist) {
        ...
        const headerContent = document.getElementById('bilising-header-cotent');
        ...
        if (playlist && playlist.length > 0) {
            ...
            `;
            headerContent.textContent = `下一首: ${nextSong.title}; 正播放: ${currentPlaying ? currentPlaying.title : '暂无歌曲'}`;
            playNextButton.disabled = false;
        } else {
            nextSong = null;
            nextSongElement.textContent = '暂无歌曲';
            headerContent.textContent = '已是最后一首歌曲; 正播放: ' + (currentPlaying ? currentPlaying.title : '暂无歌曲');
