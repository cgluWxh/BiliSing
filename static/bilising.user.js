...
(function(innerWindow) {
    ...
    innerWindow.browser = Object.assign(versions, {
      ...
      if (isWebplayer) {
        ...
        if (video) {
          video.onended = () => {
            ...
            (_document$getElementB = document.getElementById('bilising-play-next')) === null || _document$getElementB === void 0 || _document$getElementB.click();
          };
          restoreTTSQueue();
        }
    ...
    <div id="bilising-content">
        <div id="bilising-roomInfo">
            ...
            <div id="bilising-controls" style="display: none;">
                ...
                ${window.__BILISING_WEBPLAYER__ ? '<button id="bilising-play-mode">🌍 播放模式: 从源加载</button>' : '<button id="bilising-batch-add-fav">批量添加收藏夹</button>'}
